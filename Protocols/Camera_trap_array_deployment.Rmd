...
1. **Attach 40.5 mm +2 diopter over camera lens.**
    a. Using poster putty, attach diopter over camera lens making sure the diopter does not block the light or motion sensor. This will mean it is **not** centered over the lens and that the upper part of the diopter covers part of the LED IR flash. Try to block as little of the LED IR flash as possible.
