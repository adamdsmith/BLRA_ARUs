...
1. **Mount and secure the remote broadcast unit case to the T-post**
    ...
    g. Secure the unit using the security cable and combination lock.
    h. Record the orientation of the game caller on the deployment data sheet.
...
1. **Power up the SongMeter ARU**
    ...
    c. If programmed correctly, it will indicate the unit is going to sleep until it begins recording at 10 PM on the current day.
    d. Replace front panel on SongMeter (ARU).
    e. Ensure rubber rain flap is covering top seam of the SongMeter (ARU).

1. **Record the ARU (SM2) unit number, broadcast start date, sequence, and site identification information on deployment data sheet**
