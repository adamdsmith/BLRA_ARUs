---
title: "2019 Ten Thousand Islands ARU/Remote Broadcast programming reference calendar"
...
survdates2019 <- seq.Date(as.Date("2019-05-15"), as.Date("2019-06-30"), 1)

#2019 sequence programs times
seqs <- aru_sequences(25.926042, -81.566993, start = survdates2019) %>%
